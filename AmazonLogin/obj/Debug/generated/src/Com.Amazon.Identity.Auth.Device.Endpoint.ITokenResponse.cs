...
namespace Com.Amazon.Identity.Auth.Device.Endpoint {
	...
	public partial interface ITokenResponse : IJavaObject {
		...
		int StatusCode {
			...
			[Register ("getStatusCode", "()I", "GetGetStatusCodeHandler:Com.Amazon.Identity.Auth.Device.Endpoint.ITokenResponseInvoker, AmazonLogin")] get;
		}
		...
		[Register ("parse", "()V", "GetParseHandler:Com.Amazon.Identity.Auth.Device.Endpoint.ITokenResponseInvoker, AmazonLogin")]
		void Parse ();
