...
namespace Com.Amazon.Identity.Auth.Device.Datastore {
	...
	public sealed partial class AuthorizationCodeDataSource : global::Com.Amazon.Identity.Auth.Device.Datastore.AbstractDataSource {
		...
		public unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode _cursorToObject (global::Android.Database.ICursor p0)
		{
			...
			try {
				...
				global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode> (JNIEnv.CallObjectMethod  (Handle, id_cursorToObject_Landroid_database_Cursor_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::System.Collections.Generic.IList<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode> FindByAppId (string p0)
		{
		...
		public unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode FindById (long p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode> (JNIEnv.CallObjectMethod  (Handle, id_findById_J, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode FindByPrimaryKey (long p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationCode> (JNIEnv.CallObjectMethod  (Handle, id_findByPrimaryKey_J, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Datastore.AuthorizationCodeDataSource GetInstance (global::Android.Content.Context p0)
		{
