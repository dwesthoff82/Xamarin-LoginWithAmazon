...
namespace Com.Amazon.Identity.Auth.Device.Authorization {
	...
	public sealed partial class ScopesHelper : global::Java.Lang.Object {
		...
		public static unsafe string[] GetScopesFromString (string p0)
		{
			...
			try {
				...
				string[] __ret = (string[]) JNIEnv.GetArray (JNIEnv.CallStaticObjectMethod  (class_ref, id_getScopesFromString_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef, typeof (string));
				return __ret;
			} finally {
		...
		public static unsafe string GetScopesString (string[] p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_p0);
				string __ret = JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_getScopesString_arrayLjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
