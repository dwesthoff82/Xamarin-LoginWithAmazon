...
namespace Com.Amazon.Identity.Auth.Device.Thread {
	...
	public partial class AuthzCallbackFuture : global::Com.Amazon.Identity.Auth.Device.Thread.MAPCallbackFuture, global::Com.Amazon.Identity.Auth.Device.Authorization.Api.IAuthorizationListener {
		...
		public unsafe AuthzCallbackFuture (global::Com.Amazon.Identity.Auth.Device.Shared.IAPIListener p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AuthzCallbackFuture)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/amazon/identity/auth/device/shared/APIListener;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/amazon/identity/auth/device/shared/APIListener;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_amazon_identity_auth_device_shared_APIListener_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_amazon_identity_auth_device_shared_APIListener_, __args);
			} finally {
			}
		}
		...
		public unsafe AuthzCallbackFuture (global::Com.Amazon.Identity.Auth.Device.Authorization.Api.IAuthorizationListener p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		[Register (".ctor", "()V", "")]
		public unsafe AuthzCallbackFuture ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnCancel (global::Android.OS.Bundle p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onCancel_Landroid_os_Bundle_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onCancel", "(Landroid/os/Bundle;)V"), __args);
			} finally {
			}
		}
