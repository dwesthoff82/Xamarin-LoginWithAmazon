...
namespace Com.Amazon.Identity.Auth.Device.Authorization {
	...
	public partial class ThirdPartyServiceHelper : global::Java.Lang.Object {
		...
		public partial class MAPServiceInfo : global::Java.Lang.Object {
			...
			public unsafe MAPServiceInfo (global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyServiceHelper __self, global::Com.Amazon.Identity.Auth.Device.Utils.MAPVersion p1, global::Android.OS.IInterface p2, global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyAuthorizationServiceConnection p3, bool p4, global::Android.Content.PM.ResolveInfo p5, global::Android.Content.Intent p6)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (GetType () != typeof (MAPServiceInfo)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";Lcom/amazon/identity/auth/device/utils/MAPVersion;Landroid/os/IInterface;Lcom/amazon/identity/auth/device/authorization/ThirdPartyAuthorizationServiceConnection;ZLandroid/content/pm/ResolveInfo;Landroid/content/Intent;)V", __args),
								JniHandleOwnership.TransferLocalRef);
						global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";Lcom/amazon/identity/auth/device/utils/MAPVersion;Landroid/os/IInterface;Lcom/amazon/identity/auth/device/authorization/ThirdPartyAuthorizationServiceConnection;ZLandroid/content/pm/ResolveInfo;Landroid/content/Intent;)V", __args);
						return;
					}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyAuthorizationServiceConnection Connection {
				...
				get {
					...
					try {
						...
						if (GetType () == ThresholdType)
							...
							return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyAuthorizationServiceConnection> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getConnection", "()Lcom/amazon/identity/auth/device/authorization/ThirdPartyAuthorizationServiceConnection;")), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}
				...
				get {
					...
					try {
						...
						if (GetType () == ThresholdType)
							...
							return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isPrimary", "()Z"));
					} finally {
					}
				}
			}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Utils.MAPVersion MapVersion {
				...
				get {
					...
					try {
						...
						if (GetType () == ThresholdType)
							...
							return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Utils.MAPVersion> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMapVersion", "()Lcom/amazon/identity/auth/device/utils/MAPVersion;")), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Android.OS.IInterface Service {
				...
				get {
					...
					try {
						...
						if (GetType () == ThresholdType)
							...
							return global::Java.Lang.Object.GetObject<global::Android.OS.IInterface> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getService", "()Landroid/os/IInterface;")), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
				...
				set {
					...
					try {
						...
						if (GetType () == ThresholdType)
							JNIEnv.CallVoidMethod  (Handle, id_setService_Landroid_os_IInterface_, __args);
						else
							JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setService", "(Landroid/os/IInterface;)V"), __args);
					} finally {
					}
				}
			}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Android.Content.Intent ServiceIntent {
				...
				get {
					...
					try {
						...
						if (GetType () == ThresholdType)
							...
							return global::Java.Lang.Object.GetObject<global::Android.Content.Intent> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getServiceIntent", "()Landroid/content/Intent;")), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
				...
				set {
					...
					try {
						...
						if (GetType () == ThresholdType)
							JNIEnv.CallVoidMethod  (Handle, id_setServiceIntent_Landroid_content_Intent_, __args);
						else
							JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setServiceIntent", "(Landroid/content/Intent;)V"), __args);
					} finally {
					}
				}
			}
		...
		[Register (".ctor", "()V", "")]
		public unsafe ThirdPartyServiceHelper ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static unsafe void ClearCachedService (global::Android.Content.Context p0)
		{
			...
			try {
				...
				JNIEnv.CallStaticVoidMethod  (class_ref, id_clearCachedService_Landroid_content_Context_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Android.OS.IInterface GetAuthorizationServiceInstance (global::Android.Content.Context p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Android.OS.IInterface> (JNIEnv.CallObjectMethod  (Handle, id_getAuthorizationServiceInstance_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Android.OS.IInterface> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAuthorizationServiceInstance", "(Landroid/content/Context;)Landroid/os/IInterface;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.IAmazonAuthorizationServiceInterface GetRemoteAndroidService (global::Android.Content.Context p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Amazon.Identity.Auth.Device.Authorization.IAmazonAuthorizationServiceInterface __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.IAmazonAuthorizationServiceInterface> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getRemoteAndroidService_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public static unsafe void Unbind (global::Android.Content.Context p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_unbind_Landroid_content_Context_, __args);
			} finally {
			}
		}
