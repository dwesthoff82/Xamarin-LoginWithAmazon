...
namespace Com.Amazon.Identity.Auth.Device.Datastore {
	...
	public partial class ProfileDataSource : global::Com.Amazon.Identity.Auth.Device.Datastore.AbstractDataSource {
		...
		public unsafe ProfileDataSource (global::Android.Database.Sqlite.SQLiteDatabase p0)
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTableName", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		static Delegate Get_cursorToObject_Landroid_database_Cursor_Handler ()
		{
			if (cb_cursorToObject_Landroid_database_Cursor_ == null)
				cb_cursorToObject_Landroid_database_Cursor_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n__cursorToObject_Landroid_database_Cursor_);
			return cb_cursorToObject_Landroid_database_Cursor_;
		}

		static IntPtr n__cursorToObject_Landroid_database_Cursor_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Identity.Auth.Device.Datastore.ProfileDataSource __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.ProfileDataSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this._cursorToObject (p0));
			return __ret;
		}
#pragma warning restore 0169
		...
		[Register ("cursorToObject", "(Landroid/database/Cursor;)Lcom/amazon/identity/auth/device/dataobject/Profile;", "Get_cursorToObject_Landroid_database_Cursor_Handler")]
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile _cursorToObject (global::Android.Database.ICursor p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile> (JNIEnv.CallObjectMethod  (Handle, id_cursorToObject_Landroid_database_Cursor_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "cursorToObject", "(Landroid/database/Cursor;)Lcom/amazon/identity/auth/device/dataobject/Profile;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public override unsafe string[] GetAllColumns ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAllColumns", "()[Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef, typeof (string));
			} finally {
			}
		}
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Datastore.ProfileDataSource GetInstance (global::Android.Content.Context p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Amazon.Identity.Auth.Device.Datastore.ProfileDataSource __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.ProfileDataSource> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getInstance_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile GetProfile (string p0)
		{
			...
			try {
				...
				global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile> (JNIEnv.CallObjectMethod  (Handle, id_getProfile_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.Profile> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getProfile", "(Ljava/lang/String;)Lcom/amazon/identity/auth/device/dataobject/Profile;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
