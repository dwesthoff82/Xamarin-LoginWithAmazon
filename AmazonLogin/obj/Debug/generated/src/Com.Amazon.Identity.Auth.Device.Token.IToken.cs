...
namespace Com.Amazon.Identity.Auth.Device.Token {
	...
	[global::System.Obsolete ("Use the 'Token' type. This type will be removed in a future release.")]
	...
	public partial interface IToken : IJavaObject {
		...
		global::System.Collections.Generic.IDictionary<string, string> Data {
			...
			[Register ("getData", "()Ljava/util/Map;", "GetGetDataHandler:Com.Amazon.Identity.Auth.Device.Token.ITokenInvoker, AmazonLogin")] get;
		}
		...
		string DirectedId {
			...
			[Register ("getDirectedId", "()Ljava/lang/String;", "GetGetDirectedIdHandler:Com.Amazon.Identity.Auth.Device.Token.ITokenInvoker, AmazonLogin")] get;
		}
		...
		global::Android.Text.Format.Time LocalTimestamp {
			...
			[Register ("getLocalTimestamp", "()Landroid/text/format/Time;", "GetGetLocalTimestampHandler:Com.Amazon.Identity.Auth.Device.Token.ITokenInvoker, AmazonLogin")] get;
		}
		...
		string Type {
			...
			[Register ("getType", "()Ljava/lang/String;", "GetGetTypeHandler:Com.Amazon.Identity.Auth.Device.Token.ITokenInvoker, AmazonLogin")] get;
		}
		...
		[Register ("toString", "()Ljava/lang/String;", "GetToStringHandler:Com.Amazon.Identity.Auth.Device.Token.ITokenInvoker, AmazonLogin")]
		string ToString ();
...
#pragma warning restore 0169
		...
		public unsafe string DirectedId {
			get {
...
#pragma warning restore 0169
		...
		public unsafe global::Android.Text.Format.Time LocalTimestamp {
			get {
