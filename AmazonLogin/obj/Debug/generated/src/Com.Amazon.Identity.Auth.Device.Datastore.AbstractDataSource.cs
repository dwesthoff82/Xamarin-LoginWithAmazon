...
namespace Com.Amazon.Identity.Auth.Device.Datastore {
	...
	public abstract partial class AbstractDataSource : global::Java.Lang.Object {
		...
		public unsafe AbstractDataSource (global::Android.Database.Sqlite.SQLiteDatabase p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AbstractDataSource)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/database/sqlite/SQLiteDatabase;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/database/sqlite/SQLiteDatabase;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_database_sqlite_SQLiteDatabase_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_database_sqlite_SQLiteDatabase_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe int DeleteAllRows ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "deleteAllRows", "()I"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool DeleteRow (long p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_deleteRow_J, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "deleteRow", "(J)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe int DeleteRows (string[] p0, string[] p1)
		{
			...
			try {
				...
				int __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallIntMethod  (Handle, id_deleteRows_arrayLjava_lang_String_arrayLjava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "deleteRows", "([Ljava/lang/String;[Ljava/lang/String;)I"), __args);
				return __ret;
			} finally {
				if (p0 != null) {
...
#pragma warning restore 0169
		...
		protected virtual unsafe int DeleteRowsBySingleColumn (string p0, string p1)
		{
			...
			try {
				...
				int __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallIntMethod  (Handle, id_deleteRowsBySingleColumn_Ljava_lang_String_Ljava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "deleteRowsBySingleColumn", "(Ljava/lang/String;Ljava/lang/String;)I"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.IList FindAllRows ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findAllRows", "()Ljava/util/List;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.IList FindAllRows (string[] p0, string[] p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_findAllRows_arrayLjava_lang_String_arrayLjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findAllRows", "([Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::System.Collections.IList FindAllRowsBySingleColumn (string p0, string p1)
		{
			...
			try {
				...
				global::System.Collections.IList __ret;
				if (GetType () == ThresholdType)
					__ret = global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_findAllRowsBySingleColumn_Ljava_lang_String_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findAllRowsBySingleColumn", "(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Object FindByRowId (long p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod  (Handle, id_findByRowId_J, __args), JniHandleOwnership.TransferLocalRef);
				else
					return (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findByRowId", "(J)Lcom/amazon/identity/auth/device/dataobject/AbstractDataObject;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Object FindOneRow (string[] p0, string[] p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod  (Handle, id_findOneRow_arrayLjava_lang_String_arrayLjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findOneRow", "([Ljava/lang/String;[Ljava/lang/String;)Lcom/amazon/identity/auth/device/dataobject/AbstractDataObject;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::Java.Lang.Object FindOneRowBySingleColumn (string p0, string p1)
		{
			...
			try {
				...
				global::Java.Lang.Object __ret;
				if (GetType () == ThresholdType)
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod  (Handle, id_findOneRowBySingleColumn_Ljava_lang_String_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "findOneRowBySingleColumn", "(Ljava/lang/String;Ljava/lang/String;)Lcom/amazon/identity/auth/device/dataobject/AbstractDataObject;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
...
#pragma warning restore 0169
		...
		public virtual unsafe int GetColumnIndex (global::Android.Database.ICursor p0, int p1)
		{
			...
			try {
				...
				int __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallIntMethod  (Handle, id_getColumnIndex_Landroid_database_Cursor_I, __args);
				else
					__ret = JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getColumnIndex", "(Landroid/database/Cursor;I)I"), __args);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.identity.auth.device.datastore']/class[@name='AbstractDataSource']/method[@name='insertRow' and count(parameter)=1 and parameter[1][@type='K']]"
		...
		public virtual unsafe long InsertRow (global::Java.Lang.Object p0)
		{
			...
			try {
				...
				long __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallLongMethod  (Handle, id_insertRow_Lcom_amazon_identity_auth_device_dataobject_AbstractDataObject_, __args);
				else
					__ret = JNIEnv.CallNonvirtualLongMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "insertRow", "(Lcom/amazon/identity/auth/device/dataobject/AbstractDataObject;)J"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool UpdateRow (long p0, global::Android.Content.ContentValues p1)
		{
			...
			try {
				...
				bool __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_updateRow_JLandroid_content_ContentValues_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "updateRow", "(JLandroid/content/ContentValues;)Z"), __args);
				return __ret;
			} finally {
			}
		}
	...
	internal partial class AbstractDataSourceInvoker : AbstractDataSource {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.identity.auth.device.datastore']/class[@name='AbstractDataSource']/method[@name='cursorToObject' and count(parameter)=1 and parameter[1][@type='android.database.Cursor']]"
		[Register ("cursorToObject", "(Landroid/database/Cursor;)Lcom/amazon/identity/auth/device/dataobject/AbstractDataObject;", "GetCursorToObject_Landroid_database_Cursor_Handler")]
		public override unsafe global::Java.Lang.Object CursorToObject (global::Android.Database.ICursor p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Java.Lang.Object __ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod  (Handle, id_cursorToObject_Landroid_database_Cursor_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
