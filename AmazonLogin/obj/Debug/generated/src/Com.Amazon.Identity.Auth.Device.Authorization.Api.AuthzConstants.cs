...
namespace Com.Amazon.Identity.Auth.Device.Authorization.Api {
	...
	public sealed partial class AuthzConstants : global::Java.Lang.Object {
		...
		public sealed partial class BUNDLE_KEY : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.BUNDLE_KEY ValueOf (string p0)
			{
				...
				try {
					...
					global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.BUNDLE_KEY __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.BUNDLE_KEY> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.BUNDLE_KEY[] Values ()
			{
		...
		public sealed partial class FUTURE_TYPE : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.FUTURE_TYPE ValueOf (string p0)
			{
				if (id_valueOf_Ljava_lang_String_ == IntPtr.Zero)
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (native_p0);
					global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.FUTURE_TYPE __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.FUTURE_TYPE> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.FUTURE_TYPE[] Values ()
			{
				if (id_values == IntPtr.Zero)
		...
		public sealed partial class PROFILE_KEY : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.PROFILE_KEY ValueOf (string p0)
			{
				if (id_valueOf_Ljava_lang_String_ == IntPtr.Zero)
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (native_p0);
					global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.PROFILE_KEY __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.PROFILE_KEY> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Authorization.Api.AuthzConstants.PROFILE_KEY[] Values ()
			{
				if (id_values == IntPtr.Zero)
