...
namespace Com.Amazon.Identity.Auth.Device.Datastore {
	...
	public sealed partial class DatabaseHelper : global::Android.Database.Sqlite.SQLiteOpenHelper {
		...
		public unsafe DatabaseHelper (global::Android.Content.Context p0)
		...
		public static unsafe void ClearAuthorizationState (global::Android.Content.Context p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_clearAuthorizationState_Landroid_content_Context_, __args);
			} finally {
			}
		}
		...
		public static unsafe void ClearServiceAuthorizationState (global::Android.Content.Context p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_clearServiceAuthorizationState_Landroid_content_Context_, __args);
			} finally {
			}
		}
		...
		public unsafe bool DoesColumnExist (global::Android.Database.Sqlite.SQLiteDatabase p0, string p1, string p2)
		{
			...
			try {
				...
				bool __ret = JNIEnv.CallBooleanMethod  (Handle, id_doesColumnExist_Landroid_database_sqlite_SQLiteDatabase_Ljava_lang_String_Ljava_lang_String_, __args);
				return __ret;
			} finally {
		...
		public static unsafe global::Java.Util.Date TruncateFractionalSeconds (global::Java.Util.Date p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Java.Util.Date __ret = global::Java.Lang.Object.GetObject<global::Java.Util.Date> (JNIEnv.CallStaticObjectMethod  (class_ref, id_truncateFractionalSeconds_Ljava_util_Date_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
