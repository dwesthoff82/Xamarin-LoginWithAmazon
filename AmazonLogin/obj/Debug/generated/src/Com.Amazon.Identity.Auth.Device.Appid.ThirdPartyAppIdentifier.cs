...
namespace Com.Amazon.Identity.Auth.Device.Appid {
	...
	public sealed partial class ThirdPartyAppIdentifier : global::Com.Amazon.Identity.Auth.Device.Appid.AbstractAppIdentifier {
		...
		[Register (".ctor", "()V", "")]
		public unsafe ThirdPartyAppIdentifier ()
		...
		public unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo GetAppInfoByApiKey (string p0, string p1, global::Android.Content.Context p2)
		{
			...
			try {
				...
				global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo> (JNIEnv.CallObjectMethod  (Handle, id_getAppInfoByApiKey_Ljava_lang_String_Ljava_lang_String_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
		...
		public unsafe bool IsAPIKeyValidFormat (string p0, string p1, global::Android.Content.Context p2)
		{
			...
			try {
				...
				__args [1] = new JValue (native_p1);
				__args [2] = new JValue (p2);
				bool __ret = JNIEnv.CallBooleanMethod  (Handle, id_isAPIKeyValidFormat_Ljava_lang_String_Ljava_lang_String_Landroid_content_Context_, __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
