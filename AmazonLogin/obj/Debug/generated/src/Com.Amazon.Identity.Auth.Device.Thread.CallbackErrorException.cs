...
namespace Com.Amazon.Identity.Auth.Device.Thread {
	...
	public partial class CallbackErrorException : global::Java.Util.Concurrent.ExecutionException {
		...
		public unsafe CallbackErrorException (global::Android.OS.Bundle p0)
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Android.OS.Bundle ErrorBundle {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getErrorBundle", "()Landroid/os/Bundle;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
