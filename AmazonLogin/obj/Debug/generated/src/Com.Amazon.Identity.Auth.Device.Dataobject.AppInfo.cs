...
namespace Com.Amazon.Identity.Auth.Device.Dataobject {
	...
	public partial class AppInfo : global::Com.Amazon.Identity.Auth.Device.Dataobject.AbstractDataObject {
		...
		public sealed partial class COL_INDEX : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo.COL_INDEX ValueOf (string p0)
			{
				...
				try {
					...
					global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo.COL_INDEX __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo.COL_INDEX> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo.COL_INDEX[] Values ()
			{
		...
		public unsafe AppInfo (string p0, string p1, string p2, string[] p3, string[] p4, string p5, global::Org.Json.JSONObject p6)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (GetType () != typeof (AppInfo)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_arrayLjava_lang_String_arrayLjava_lang_String_Ljava_lang_String_Lorg_json_JSONObject_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_arrayLjava_lang_String_arrayLjava_lang_String_Ljava_lang_String_Lorg_json_JSONObject_, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		public virtual unsafe string AppVariantId {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAppVariantId", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setAppVariantId_Ljava_lang_String_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setAppVariantId", "(Ljava/lang/String;)V"), __args);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		public virtual unsafe string PackageName {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getPackageName", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setPackageName_Ljava_lang_String_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setPackageName", "(Ljava/lang/String;)V"), __args);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo Clone ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "clone", "()Lcom/amazon/identity/auth/device/dataobject/AppInfo;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string[] GetAllowedRemoteScopes ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAllowedRemoteScopes", "()[Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef, typeof (string));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string[] GetAllowedScopes ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAllowedScopes", "()[Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef, typeof (string));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string GetAttributeByKey (string p0)
		{
			...
			try {
				...
				string __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_getAttributeByKey_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAttributeByKey", "(Ljava/lang/String;)Ljava/lang/String;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
...
#pragma warning restore 0169
		...
		[Register ("getDataSource", "(Landroid/content/Context;)Lcom/amazon/identity/auth/device/datastore/AppInfoDataSource;", "Get_getDataSource_Landroid_content_Context_Handler")]
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Datastore.AppInfoDataSource _getDataSource (global::Android.Content.Context p0)
		{
			...
			try {
				...
				global::Com.Amazon.Identity.Auth.Device.Datastore.AppInfoDataSource __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.AppInfoDataSource> (JNIEnv.CallObjectMethod  (Handle, id_getDataSource_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.AppInfoDataSource> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getDataSource", "(Landroid/content/Context;)Lcom/amazon/identity/auth/device/datastore/AppInfoDataSource;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string[] GetGrantedPermissions ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getGrantedPermissions", "()[Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef, typeof (string));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetAllowedScopes (string[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setAllowedScopes_arrayLjava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setAllowedScopes", "([Ljava/lang/String;)V"), __args);
			} finally {
				if (p0 != null) {
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetGrantedPermissions (string[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setGrantedPermissions_arrayLjava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setGrantedPermissions", "([Ljava/lang/String;)V"), __args);
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
					JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetPayload (string p0)
		{
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetPayload (global::Org.Json.JSONObject p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setPayload_Lorg_json_JSONObject_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setPayload", "(Lorg/json/JSONObject;)V"), __args);
			} finally {
			}
		}
