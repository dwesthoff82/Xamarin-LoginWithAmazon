...
namespace Com.Amazon.Identity.Auth.Device.Dataobject {
	...
	public abstract partial class AuthorizationToken : global::Com.Amazon.Identity.Auth.Device.Dataobject.AbstractDataObject, global::Com.Amazon.Identity.Auth.Device.Token.IToken {
		...
		public sealed partial class AUTHZ_TOKEN_TYPE : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE ValueOf (string p0)
			{
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE[] Values ()
			{
		...
		public sealed partial class COL_INDEX : global::Java.Lang.Enum {
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.COL_INDEX ValueOf (string p0)
			{
				if (id_valueOf_Ljava_lang_String_ == IntPtr.Zero)
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (native_p0);
					global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.COL_INDEX __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.COL_INDEX> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
			...
			public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.COL_INDEX[] Values ()
			{
				if (id_values == IntPtr.Zero)
		...
		public unsafe AuthorizationToken (string p0, string p1, string p2, global::Java.Util.Date p3, global::Java.Util.Date p4, byte[] p5, global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE p6)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AuthorizationToken)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;[BLcom/amazon/identity/auth/device/dataobject/AuthorizationToken$AUTHZ_TOKEN_TYPE;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;[BLcom/amazon/identity/auth/device/dataobject/AuthorizationToken$AUTHZ_TOKEN_TYPE;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_util_Date_Ljava_util_Date_arrayBLcom_amazon_identity_auth_device_dataobject_AuthorizationToken_AUTHZ_TOKEN_TYPE_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Ljava_util_Date_Ljava_util_Date_arrayBLcom_amazon_identity_auth_device_dataobject_AuthorizationToken_AUTHZ_TOKEN_TYPE_, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
		...
		[Register (".ctor", "()V", "")]
		public unsafe AuthorizationToken ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.Date CreationTime {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Java.Util.Date> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCreationTime", "()Ljava/util/Date;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setCreationTime_Ljava_util_Date_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setCreationTime", "(Ljava/util/Date;)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsRemainingLifeAcceptable {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isRemainingLifeAcceptable", "()Z"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Android.Text.Format.Time LocalTimestamp {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Android.Text.Format.Time> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getLocalTimestamp", "()Landroid/text/format/Time;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string TokenValue {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTokenValue", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setTokenValue_Ljava_lang_String_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setTokenValue", "(Ljava/lang/String;)V"), __args);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE TypeAsEnum {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTypeAsEnum", "()Lcom/amazon/identity/auth/device/dataobject/AuthorizationToken$AUTHZ_TOKEN_TYPE;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		[Register ("getDataSource", "(Landroid/content/Context;)Lcom/amazon/identity/auth/device/datastore/AuthorizationTokenDataSource;", "Get_getDataSource_Landroid_content_Context_Handler")]
		public virtual unsafe global::Com.Amazon.Identity.Auth.Device.Datastore.AuthorizationTokenDataSource _getDataSource (global::Android.Content.Context p0)
		{
			...
			try {
				...
				global::Com.Amazon.Identity.Auth.Device.Datastore.AuthorizationTokenDataSource __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.AuthorizationTokenDataSource> (JNIEnv.CallObjectMethod  (Handle, id_getDataSource_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Datastore.AuthorizationTokenDataSource> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getDataSource", "(Landroid/content/Context;)Lcom/amazon/identity/auth/device/datastore/AuthorizationTokenDataSource;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe byte[] GetMiscData ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (byte[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMiscData", "()[B")), JniHandleOwnership.TransferLocalRef, typeof (byte));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetMiscData (byte[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setMiscData_arrayB, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMiscData", "([B)V"), __args);
			} finally {
				if (p0 != null) {
