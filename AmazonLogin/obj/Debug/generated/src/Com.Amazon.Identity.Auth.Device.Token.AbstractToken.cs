...
namespace Com.Amazon.Identity.Auth.Device.Token {
	...
	public abstract partial class AbstractToken : global::Java.Lang.Object, global::Com.Amazon.Identity.Auth.Device.Token.IToken {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.identity.auth.device.token']/class[@name='AbstractToken']/constructor[@name='AbstractToken' and count(parameter)=1 and parameter[1][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;']]"
		[Register (".ctor", "(Ljava/util/Map;)V", "")]
		public unsafe AbstractToken (global::System.Collections.Generic.IDictionary<string, string> p0)
		...
		public unsafe AbstractToken (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public unsafe AbstractToken (global::Com.Amazon.Identity.Auth.Device.Token.AbstractToken p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (GetType () != typeof (AbstractToken)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/amazon/identity/auth/device/token/AbstractToken;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/amazon/identity/auth/device/token/AbstractToken;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_amazon_identity_auth_device_token_AbstractToken_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_amazon_identity_auth_device_token_AbstractToken_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.AccountManagerConstants.REGION_HINT ConvertStringToRegionHint (string p0)
		{
		...
		protected static unsafe long MillisToSecs (long p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return JNIEnv.CallStaticLongMethod  (class_ref, id_millisToSecs_J, __args);
			} finally {
			}
		}
		...
		public static unsafe long SecsToMillis (long p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return JNIEnv.CallStaticLongMethod  (class_ref, id_secsToMillis_J, __args);
			} finally {
			}
		}
