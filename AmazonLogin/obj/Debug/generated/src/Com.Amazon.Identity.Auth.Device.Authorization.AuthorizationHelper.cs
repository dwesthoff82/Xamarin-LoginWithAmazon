...
namespace Com.Amazon.Identity.Auth.Device.Authorization {
	...
	public partial class AuthorizationHelper : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public unsafe AuthorizationHelper ()
...
#pragma warning restore 0169
		...
		public virtual unsafe void Authorize (global::Android.Content.Context p0, string p1, string p2, string[] p3, bool p4, global::Com.Amazon.Identity.Auth.Device.Authorization.Api.IAuthorizationListener p5)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_authorize_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_arrayLjava_lang_String_ZLcom_amazon_identity_auth_device_authorization_api_AuthorizationListener_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "authorize", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;ZLcom/amazon/identity/auth/device/authorization/api/AuthorizationListener;)V"), __args);
			} finally {
		...
		public static unsafe string GetOAuth2Url (global::Android.Content.Context p0, string p1, string p2, string[] p3, string p4, bool p5)
		{
			...
			try {
				...
				__args [5] = new JValue (p5);
				string __ret = JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_getOAuth2Url_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_arrayLjava_lang_String_Ljava_lang_String_Z, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
				JNIEnv.DeleteLocalRef (native_p2);
