...
namespace Com.Amazon.Identity.Auth.Device.Utils {
	...
	public partial class ThirdPartyResourceParser : global::Java.Lang.Object {
		...
		public unsafe ThirdPartyResourceParser (global::Android.Content.Context p0, string p1)
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsApiKeyInAssest {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isApiKeyInAssest", "()Z"));
				} finally {
				}
			}
		}
