...
namespace Com.Amazon.Identity.Auth.Device.Endpoint {
	...
	public partial interface IRequestUrlBuilder : IJavaObject {
		...
		string Domain {
			...
			[Register ("getDomain", "()Ljava/lang/String;", "GetGetDomainHandler:Com.Amazon.Identity.Auth.Device.Endpoint.IRequestUrlBuilderInvoker, AmazonLogin")] get;
		}
		...
		int Port {
			...
			[Register ("getPort", "()I", "GetGetPortHandler:Com.Amazon.Identity.Auth.Device.Endpoint.IRequestUrlBuilderInvoker, AmazonLogin")] get;
		}
		...
		string RequestUrl {
			...
			[Register ("getRequestUrl", "()Ljava/lang/String;", "GetGetRequestUrlHandler:Com.Amazon.Identity.Auth.Device.Endpoint.IRequestUrlBuilderInvoker, AmazonLogin")] get;
		}
