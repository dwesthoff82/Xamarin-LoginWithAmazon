...
namespace Com.Amazon.Identity.Auth.Device.Authorization.Api {
	...
	public partial class AmazonAuthorizationManager : global::Java.Lang.Object {
		...
		public unsafe AmazonAuthorizationManager (global::Android.Content.Context p0, global::Android.OS.Bundle p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AmazonAuthorizationManager)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/content/Context;Landroid/os/Bundle;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/content/Context;Landroid/os/Bundle;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_content_Context_Landroid_os_Bundle_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_content_Context_Landroid_os_Bundle_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.Concurrent.IFuture Authorize (string[] p0, global::Android.OS.Bundle p1, global::Com.Amazon.Identity.Auth.Device.Authorization.Api.IAuthorizationListener p2)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallObjectMethod  (Handle, id_authorize_arrayLjava_lang_String_Landroid_os_Bundle_Lcom_amazon_identity_auth_device_authorization_api_AuthorizationListener_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "authorize", "([Ljava/lang/String;Landroid/os/Bundle;Lcom/amazon/identity/auth/device/authorization/api/AuthorizationListener;)Ljava/util/concurrent/Future;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.Concurrent.IFuture ClearAuthorizationState (global::Com.Amazon.Identity.Auth.Device.Shared.IAPIListener p0)
		{
			...
			try {
				...
				global::Java.Util.Concurrent.IFuture __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallObjectMethod  (Handle, id_clearAuthorizationState_Lcom_amazon_identity_auth_device_shared_APIListener_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "clearAuthorizationState", "(Lcom/amazon/identity/auth/device/shared/APIListener;)Ljava/util/concurrent/Future;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.Concurrent.IFuture GetProfile (global::Com.Amazon.Identity.Auth.Device.Shared.IAPIListener p0)
		{
			...
			try {
				...
				global::Java.Util.Concurrent.IFuture __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallObjectMethod  (Handle, id_getProfile_Lcom_amazon_identity_auth_device_shared_APIListener_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getProfile", "(Lcom/amazon/identity/auth/device/shared/APIListener;)Ljava/util/concurrent/Future;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.Concurrent.IFuture GetToken (string[] p0, global::Com.Amazon.Identity.Auth.Device.Shared.IAPIListener p1)
		{
			...
			try {
				...
				global::Java.Util.Concurrent.IFuture __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallObjectMethod  (Handle, id_getToken_arrayLjava_lang_String_Lcom_amazon_identity_auth_device_shared_APIListener_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Java.Util.Concurrent.IFuture> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getToken", "([Ljava/lang/String;Lcom/amazon/identity/auth/device/shared/APIListener;)Ljava/util/concurrent/Future;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
