...
namespace Com.Amazon.Identity.Auth.Device.Authorization {
	...
	public abstract partial class MAPServiceConnection : global::Java.Lang.Object, global::Android.Content.IServiceConnection {
		...
		[Register (".ctor", "()V", "")]
		public unsafe MAPServiceConnection ()
...
#pragma warning restore 0169
		...
		protected virtual unsafe bool IsValidService (global::Android.OS.IBinder p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_isValidService_Landroid_os_IBinder_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isValidService", "(Landroid/os/IBinder;)Z"), __args);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnServiceConnected (global::Android.Content.ComponentName p0, global::Android.OS.IBinder p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onServiceConnected_Landroid_content_ComponentName_Landroid_os_IBinder_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onServiceConnected", "(Landroid/content/ComponentName;Landroid/os/IBinder;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnServiceDisconnected (global::Android.Content.ComponentName p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onServiceDisconnected_Landroid_content_ComponentName_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onServiceDisconnected", "(Landroid/content/ComponentName;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetServiceListener (global::Com.Amazon.Identity.Auth.Device.Authorization.IAmazonServiceListener p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setServiceListener_Lcom_amazon_identity_auth_device_authorization_AmazonServiceListener_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setServiceListener", "(Lcom/amazon/identity/auth/device/authorization/AmazonServiceListener;)V"), __args);
			} finally {
			}
		}
	...
	internal partial class MAPServiceConnectionInvoker : MAPServiceConnection {
		...
		public override unsafe global::Android.OS.IInterface GetServiceInterface (global::Android.OS.IBinder p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Android.OS.IInterface __ret = global::Java.Lang.Object.GetObject<global::Android.OS.IInterface> (JNIEnv.CallObjectMethod  (Handle, id_getServiceInterface_Landroid_os_IBinder_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
