...
namespace Com.Amazon.Identity.Auth.Device.Thread {
	...
	public partial class MAPCallbackFuture : global::Java.Lang.Object, global::Com.Amazon.Identity.Auth.Device.Shared.IAPIListener, global::Java.Util.Concurrent.IFuture {
		...
		[Register (".ctor", "()V", "")]
		public unsafe MAPCallbackFuture ()
		...
		public unsafe MAPCallbackFuture (global::Com.Amazon.Identity.Auth.Device.Authorization.Api.IAuthorizationListener p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (GetType () != typeof (MAPCallbackFuture)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/amazon/identity/auth/device/authorization/api/AuthorizationListener;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/amazon/identity/auth/device/authorization/api/AuthorizationListener;)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_amazon_identity_auth_device_authorization_api_AuthorizationListener_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_amazon_identity_auth_device_authorization_api_AuthorizationListener_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::Android.OS.Bundle ResultHelper {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getResultHelper", "()Landroid/os/Bundle;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		static Delegate Get_getHandler ()
		{
			if (cb_get == null)
				cb_get = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n__get);
			return cb_get;
		}

		static IntPtr n__get (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Amazon.Identity.Auth.Device.Thread.MAPCallbackFuture __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Thread.MAPCallbackFuture> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this._get ());
		}
#pragma warning restore 0169
		...
		[Register ("get", "()Landroid/os/Bundle;", "Get_getHandler")]
		public virtual unsafe global::Android.OS.Bundle _get ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallObjectMethod  (Handle, id_get), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get", "()Landroid/os/Bundle;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning disable 0169
		static Delegate Get_get_JLjava_util_concurrent_TimeUnit_Handler ()
		{
			if (cb_get_JLjava_util_concurrent_TimeUnit_ == null)
				cb_get_JLjava_util_concurrent_TimeUnit_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, long, IntPtr, IntPtr>) n__get_JLjava_util_concurrent_TimeUnit_);
			return cb_get_JLjava_util_concurrent_TimeUnit_;
		}

		static IntPtr n__get_JLjava_util_concurrent_TimeUnit_ (IntPtr jnienv, IntPtr native__this, long p0, IntPtr native_p1)
		{
			global::Com.Amazon.Identity.Auth.Device.Thread.MAPCallbackFuture __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Thread.MAPCallbackFuture> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this._get (p0, p1));
			return __ret;
		}
#pragma warning restore 0169
		...
		[Register ("get", "(JLjava/util/concurrent/TimeUnit;)Landroid/os/Bundle;", "Get_get_JLjava_util_concurrent_TimeUnit_Handler")]
		public virtual unsafe global::Android.OS.Bundle _get (long p0, global::Java.Util.Concurrent.TimeUnit p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallObjectMethod  (Handle, id_get_JLjava_util_concurrent_TimeUnit_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get", "(JLjava/util/concurrent/TimeUnit;)Landroid/os/Bundle;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnError (global::Com.Amazon.Identity.Auth.Device.AuthError p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onError_Lcom_amazon_identity_auth_device_AuthError_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onError", "(Lcom/amazon/identity/auth/device/AuthError;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnSuccess (global::Android.OS.Bundle p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onSuccess_Landroid_os_Bundle_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onSuccess", "(Landroid/os/Bundle;)V"), __args);
			} finally {
			}
		}
