...
namespace Com.Amazon.Identity.Auth.Device.Service {
	...
	public sealed partial class MAPServiceResult : global::Java.Lang.Object {
		...
		public static unsafe global::Android.OS.Bundle GetOnCancelBundle (int p0, string[] p1)
		{
			...
			try {
				...
				global::Android.OS.Bundle __ret = global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getOnCancelBundle_IarrayLjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				if (p1 != null) {
		...
		public static unsafe global::Android.OS.Bundle GetOnErrorBundle (global::Com.Amazon.Identity.Auth.Device.AuthError p0)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				global::Android.OS.Bundle __ret = global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getOnErrorBundle_Lcom_amazon_identity_auth_device_AuthError_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public static unsafe global::Android.OS.Bundle GetOnSuccessBundle (string p0, string p1)
		{
			...
			try {
				...
				__args [1] = new JValue (native_p1);
				global::Android.OS.Bundle __ret = global::Java.Lang.Object.GetObject<global::Android.OS.Bundle> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getOnSuccessBundle_Ljava_lang_String_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
