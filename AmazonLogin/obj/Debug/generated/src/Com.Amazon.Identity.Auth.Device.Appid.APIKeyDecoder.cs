...
namespace Com.Amazon.Identity.Auth.Device.Appid {
	...
	public sealed partial class APIKeyDecoder : global::Java.Lang.Object {
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AppInfo Decode (string p0, string p1, global::Android.Content.Context p2)
		{
		...
		public static unsafe string GetSignatureFingerprint (string p0, global::Android.Content.PM.Signature p1)
		{
			...
			try {
				...
				string __ret = JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_getSignatureFingerprint_Ljava_lang_String_Landroid_content_pm_Signature_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
