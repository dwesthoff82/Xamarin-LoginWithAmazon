...
namespace Com.Amazon.Identity.Auth.Device.Dataobject {
	...
	public sealed partial class AuthorizationTokenFactory : global::Java.Lang.Object {
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken GetAuthorizationToken (global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken.AUTHZ_TOKEN_TYPE p0)
		{
		...
		public static unsafe global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken GetCopyAuthorizationToken (global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Dataobject.AuthorizationToken> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getCopyAuthorizationToken_Lcom_amazon_identity_auth_device_dataobject_AuthorizationToken_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
